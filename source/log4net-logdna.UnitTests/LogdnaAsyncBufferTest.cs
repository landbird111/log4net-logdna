...
namespace log4net_logdna.UnitTests
{
    public class LogdnaAsyncBufferTest
    {
        private readonly Config _config;
        private readonly Mock<ILogdnaClient> _clientMock;
        ...
        public LogdnaAsyncBufferTest()
        {
            ...
            _clientMock = new Mock<ILogdnaClient>();
        ...
        public void Bulk_SendsMessagesWhenBufferSizeReached()
        {
            ...
            ExpectSends(1);
            var buffer = new LogdnaAsyncBuffer(_config, _clientMock.Object);

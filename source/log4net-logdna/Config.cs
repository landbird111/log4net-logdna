...
namespace log4net.logdna
{
    ...
    internal class Config
    {
        public Config()
        {
            UserAgent = "logdna-log4net-appender";
            TimeoutInSeconds = 30;
            MaxSendRetries = 3;
            Tag = "log4net";
        ...
        /// <summary>
        /// Max size of whole event sent to Logdna in bytes
        /// </summary>
        public int MaxEventSizeBytes { get; set; }
        /// <summary>
        /// Max size ot one bulk of events sent to Logdna in bytes
        /// </summary>
        ...
        /// <summary>
        /// How many inner exceptions should be sent to Logdna
        /// </summary>
        ...
        /// <summary>
        /// Request timeout when sending logs to Logdna
        /// </summary>

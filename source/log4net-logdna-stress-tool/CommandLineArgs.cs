...
namespace log4net_logdna_stress_tool
{
    internal class CommandLineArgs
    {
        ...
        {
            Console.WriteLine(@"
Logdna log4net logger stress testing tool.
Tool is generating log messages in one or more threads and logs them to logger.
Fake HTTP layer is used to fake sending data to Logdna, no data are really sent out.

Usage: log4net-logdna-stress-tool.exe [-n|--num-threads <NUM_THREADS>] [-d|--send-delay <SEND_DELAY_MS>] [-e|--exception-every <NUMBER>]
    ...
    -d|--send-delay      - Delay for one simulated send to Logdna servers in milliseconds. Must be >= 0. Default: 0
